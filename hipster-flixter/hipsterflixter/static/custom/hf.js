...
function create_card(title, poster, id){
    ...
    card =  "<div class='card horizontal' id='"+ id +"'>" +
            ...
            "<img src='" + poster + "'>" +       
            "</div>" +
            "<a class='btn-floating halfway-fab waves-effect waves-light red' onclick='toggleSelected("+ id +")'><i class='material-icons'>add</i></a>" +
...
function add_recs(movie_dict, obscurity){
    ...
    if(obscurity == 'high'){
        div.innerHTML += "<h4 class='header'>Is this even Vegan? (Not even Hipster) Rating: <i class='large material-icons'>whatshot</i></h4>";
    }
    else if(obscurity == 'medium'){
        div.innerHTML += "<h4 class='header'>These on vinyl? (hipper than grandpa's hip replacement) Rating: <i class='large material-icons'>whatshot</i><i class='large material-icons'>whatshot</i></h4>";
    }
    else{
        div.innerHTML += "<h4 class='header'>M'ovies Rating: <i class='large material-icons'>whatshot</i><i class='large material-icons'>whatshot</i><i class='large material-icons'>whatshot</i></h4>";
    }
